    ...
    <div className="fixed inset-0 flex items-center justify-center bg-white dark:bg-black overflow-hidden">
      <div className="shadow-input mx-auto w-full max-w-md rounded-none bg-white p-4 md:rounded-2xl md:p-8 dark:bg-black border border-neutral-200 dark:border-neutral-800">
        ...
        <form className="my-8" onSubmit={handleSubmit}>
          ...
          <button
            className="group/btn relative flex items-center justify-center block h-10 w-full rounded-md bg-gradient-to-br from-black to-neutral-600 font-medium text-white shadow-[0px_1px_0px_0px_#ffffff40_inset,0px_-1px_0px_0px_#ffffff40_inset] dark:bg-zinc-800 dark:from-zinc-900 dark:to-zinc-900 dark:shadow-[0px_1px_0px_0px_#27272a_inset,0px_-1px_0px_0px_#27272a_inset] disabled:opacity-50 disabled:cursor-not-allowed"
            type="submit"
          ...
          <div className="flex flex-col space-y-4 text-center">
            ...
            <Link
              className="text-sm text-blue-700 underline dark:text-neutral-200"
              href="/sign-up"
            >
              Sign up
            </Link>
